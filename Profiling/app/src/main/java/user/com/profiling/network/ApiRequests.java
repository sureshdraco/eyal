...
public class ApiRequests {
	...
	public static final String GET_SMS_OFFERS_URL = "http://cdn2.appicano.com/CPLOffers/SOffers.txt";
	...
	public static void getSmsOffers(Context context, Response.Listener<SmsOffers> listener, Response.ErrorListener errorListener) {
		VolleyClient
				.getInstance(context)
				.getRequestQueue()
				.add(new GsonRequest<SmsOffers>(Request.Method.GET, GET_SMS_OFFERS_URL, null, SmsOffers.class, null, listener,
						errorListener, VolleyClient.NO_RETRY_POLICY));
	}
}